...
Open **`dist/Marta_English.html`** (or the file inside `MARTA_ENGLISH_APP_LEARNER_v1.4.zip`) by double-clicking it in **Chrome or Edge**. That's it. See `docs/USER_GUIDE_FOR_MARTA_EN_HU.md`.
...
| Learner ZIP | `releases/MARTA_ENGLISH_APP_LEARNER_v1.4.zip` (HTML + start guide) |
| Source ZIP | `releases/MARTA_ENGLISH_APP_SOURCE_v1.4.zip` (reproducible) |
